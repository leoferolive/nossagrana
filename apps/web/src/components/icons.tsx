/**
 * Mapeamento semântico de ícones por domínio/contexto.
 * Centraliza o uso de lucide-react para consistência visual.
 */
export {
  // Navegação
  ...
  Target as IconOrcamento,
  Receipt as IconExtrato,
