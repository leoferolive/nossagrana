...
const LoginScreen = ({ onLogin, onSignup }) => (
  ...
  >
    <div style={{ fontSize: 36, fontWeight: 800, color: colors.primary, letterSpacing: '-1px' }}>
      NossaGrana
    </div>
    <div style={{ fontSize: 13, color: colors.textMuted, marginTop: -16 }}>
...
const SignupScreen = ({ onBack, onNext }) => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: 24, gap: 16 }}>
    <div onClick={onBack} style={{ fontSize: 13, color: colors.primary, cursor: 'pointer' }}>
      ← Voltar
    </div>
...
const FamilySetupScreen = ({ onComplete }) => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: 24, gap: 20 }}>
    ...
    <div style={{ fontSize: 13, color: colors.textMuted }}>
      Crie uma nova família ou entre com um código de convite.
    </div>
...
const SummaryCard = ({ label, value, color }) => (
  ...
  >
    ...
    <div style={{ fontSize: 20, fontWeight: 800, color, marginTop: 4, letterSpacing: '-0.5px' }}>
      {value}
    </div>
  </div>
);
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        {data.map((d, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11 }}>
            ...
            <span style={{ color: colors.text, fontWeight: 600, marginLeft: 'auto' }}>
  ...
  <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 16px' }}>
    ...
    >
      ...
      <PieChart
        data={[
          ...
          { label: 'Moradia', value: 25 },
          { label: 'Transporte', value: 15 },
    ...
    >
      ...
      <div style={{ fontSize: 12, color: colors.textMuted, lineHeight: 1.5 }}>
        Transporte ultrapassou o orçamento em{' '}
        <span style={{ color: colors.danger, fontWeight: 700 }}>R$10</span>. Lazer está em{' '}
        <span style={{ color: colors.warning, fontWeight: 700 }}>90%</span> do limite.
      </div>
    </div>
  </div>
);
          ...
          >
            <div
              style={{
                ...
                height: 36,
                borderRadius: 10,
                background: t.val > 0 ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 16,
            ...
            <div
              style={{
                fontSize: 14,
                fontWeight: 700,
                color: t.val > 0 ? colors.primary : colors.danger,
                flexShrink: 0,
              }}
            >
  ...
  <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 80px' }}>
    ...
    >
      ...
      <PieChart
        data={[
          ...
          { label: 'Moradia', value: 1588 },
          { label: 'Transporte', value: 953 },
          { label: 'Lazer', value: 635 },
          { label: 'Outros', value: 1274 },
        ]}
      />
    </div>
    <div
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        {[
          ...
          >
            ...
            <div style={{ fontSize: 18, fontWeight: 800, color: colors.text, marginTop: 4 }}>
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        >
          <span style={{ color: colors.danger }}>📈</span> Alimentação subiu 12% vs mês anterior
        </div>
        <div
          style={{
            fontSize: 12,
        ...
        >
          <span style={{ color: colors.primary }}>📉</span> Transporte caiu 8% vs mês anterior
        </div>
        <div
          style={{
            fontSize: 12,
        ...
        >
          <span style={{ color: colors.warning }}>⚠️</span> Lazer gastou 25% mais que fevereiro
        </div>
      </div>
    </div>
  </div>
...
const CategoriasScreen = ({ onBack }) => (
  <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 80px' }}>
    <div
      onClick={onBack}
      style={{ padding: '14px 4px 0', fontSize: 13, color: colors.primary, cursor: 'pointer' }}
    >
      ← Voltar
    </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ fontSize: 11, color: colors.textMuted, marginTop: 4 }}>
              {c.tipo === 'crédito'
                ? `Fecha dia ${c.fecha} · Vence dia ${c.vence}`
                : c.tipo.toUpperCase()}{' '}
              · {c.user}
            </div>
          </div>
          <span style={{ fontSize: 20 }}>
            {c.tipo === 'crédito' ? '💳' : c.tipo === 'pix' ? '⚡' : '💵'}
          </span>
        </div>
      </div>
    ))}
    ...
    {[
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <span style={{ fontSize: 11, color: colors.textMuted, cursor: 'pointer' }}>
            editar limite
          </span>
        </div>
      </div>
  ...
  <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 80px' }}>
      ...
      >
        ...
        <span
          style={{
            ...
            padding: '3px 8px',
            borderRadius: 4,
            background: m.role === 'Admin' ? 'rgba(34,197,94,0.15)' : 'rgba(139,141,152,0.15)',
            color: m.role === 'Admin' ? colors.primary : colors.textMuted,
          }}
        >
          {m.role}
        </span>
    ...
    <div style={{ marginTop: 20 }}>
      ...
      >
        ...
        <span style={{ fontSize: 11, color: colors.primary, fontWeight: 600, cursor: 'pointer' }}>
          Copiar
        </span>
      </div>
    </div>
    ...
    >
      ...
      >
                ...
                color:
                  tipo === t
                    ? t === 'despesa'
                      ...
                      : colors.primary
                    : colors.textMuted,
                border: `1px solid ${tipo === t ? (t === 'despesa' ? colors.danger : colors.primary) : colors.border}`,
                textTransform: 'capitalize',
              }}
            >
              {t}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div>
            <div
              style={{ fontSize: 11, color: colors.textMuted, marginBottom: 4, fontWeight: 600 }}
            >
              VALOR
            </div>
            <input
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
            <div
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                background: parcelado ? 'rgba(59,130,246,0.15)' : colors.card,
                color: parcelado ? colors.accent : colors.textMuted,
                border: `1px solid ${parcelado ? colors.accent : colors.border}`,
              }}
            >
              Parcelado
            </div>
            <div
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                background: recorrente ? 'rgba(59,130,246,0.15)' : colors.card,
                color: recorrente ? colors.accent : colors.textMuted,
                border: `1px solid ${recorrente ? colors.accent : colors.border}`,
              }}
            >
              Recorrente
            </div>
...
export default function NossaGranaWireframe() {
  ...
  const renderScreen = () => {
    ...
    switch (screen) {
      ...
      case 'signup':
        return (
          <SignupScreen
            ...
            onNext={() => setScreen('family-setup')}
          />
        );
      case 'family-setup':
        return <FamilySetupScreen onComplete={() => setScreen('dashboard')} />;
      case 'dashboard':
      ...
      case 'config':
        return <ConfigScreen onNavigate={(id) => setSubScreen(id)} />;
      default:
        return <DashboardScreen />;
    }
  };
  ...
  return (
    ...
    >
      ...
      {isMain && (
        ...
        >
          Navegue pelas tabs abaixo · Clique no{' '}
          <span style={{ color: colors.primary, fontWeight: 700 }}>+</span> para nova transação ·
          Acesse as sub-telas em Config
        </div>
      )}
    </div>
  );
